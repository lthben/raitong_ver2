    ...
    *bufPtr = 0;
    ...
    if (1 == sscanf(fonaNotificationBuffer, "+CMTI: " FONA_PREF_SMS_STORAGE ",%d", &slot)) {
      ...
      if (String(smsBuffer) == "Loc") {
        ...
        String(F("Unrecognized command. Available commands: 'Loc' (get location)")).toCharArray(replyMsg, 128);;
      }
...
void send_sms(String yourMobileNum, String yourMessage) {
  SMSquota--;
  fonaSS.println("AT+CMGSO=\"" + yourMobileNum + "\",\"(" + String(SMSquota) + "sms left) " + yourMessage + "\"");
}
